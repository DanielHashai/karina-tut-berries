  ...
  useEffect(() => {
    for (let i = 0; i < foodItems?.length; i++) {
      if (foodItems[i]?.id === itemId) {
        ...
        setImageAsset(foodItems[i].imageURL);
        setImageAsset2(foodItems[i].imageURL2);
        setImageAsset3(foodItems[i].imageURL3);
        setCategory(foodItems[i].category);
        setSmallBox(foodItems[i].smallBox);
        setMediumBox(foodItems[i].mediumBox);
        setLargeBox(foodItems[i].largeBox);
      }
    }
  }, []);
  const uploadImage = (e) => {
