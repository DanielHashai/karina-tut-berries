...
const RowContainerMenu = ({ flag, data, scrollValue }) => {
    ...
    >
      {data && data.length > 0 ? (
        data.map((item) => (
          <div
            key={item?.id}
            className="w-275 h-[175px] min-w-[275px] md:w-300 md:min-w-[300px]   rounded-lg py-2 px-4  my-12  flex flex-col items-center justify-evenly relative"
          >
            <div
              style={{ gap: "10px" }}
